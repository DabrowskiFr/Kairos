...
domain_frontend="$tmpdir/domain.frontend.txt"
...
"$cli" --check-frontend "$domain" > "$domain_frontend"
...
require_contains "$domain_frontend" "guarantees=4" "frontend quantified-contract split"
