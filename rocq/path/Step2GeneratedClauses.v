...
Module Step2GeneratedClauses.
  Definition StepCtx := @KairosOracleModel.StepCtx.
  Definition ctx_at := @KairosOracleModel.ctx_at.
  Definition Clause := @KairosOracleModel.Clause.
