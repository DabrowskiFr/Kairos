...
(** {1 Environment Types}
    Internal environment used by Why3 emission and normalization helpers. *)
...
val term_of_instance_var :
  env -> Ast.ident -> Ast.ident -> Ast.ident -> Why3.Ptree.term
(** Build an expression from instance var. *)
val expr_of_instance_var :
  env -> Ast.ident -> Ast.ident -> Ast.ident -> Why3.Ptree.expr
