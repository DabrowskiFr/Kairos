...
(** {1 Expression Collection}
    Collectors traverse expressions/formulas and accumulate referenced
    historical expressions ([hexpr]) or call sites. These helpers are used
    by monitor generation and OBC+ instrumentation. *)
