...
(** [ensures] is the Rocq-facing structural postcondition set.
    [elaboration_checks] contains proof checks generated by frontend
    desugaring, such as history definitions. *)
