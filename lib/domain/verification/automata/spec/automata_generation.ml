...
let build_guarantee_automaton
  ...
  build_automaton ~atom_map ~atom_named_exprs ~atom_names spec
...
let build_for_node
  ...
  let guarantee_automaton =
    build_guarantee_automaton ~build_automaton ~atom_map:atoms.atom_map
      ~atom_named_exprs:atoms.atom_named_exprs
  ...
  let assume_atoms, assume_atom_names, assume_spec, assume_automaton =
    if node_spec.spec_assumes = [] then (None, [], None, None)
      ...
      let automaton_a =
        build_guarantee_automaton ~build_automaton ~atom_map:atoms_a.atom_map
