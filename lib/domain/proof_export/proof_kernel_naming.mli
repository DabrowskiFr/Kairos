...
(** [string_of_product_state] service entrypoint. *)

val string_of_product_state : Proof_kernel_types.product_state_ir -> string
(** [string_of_edge] service entrypoint. *)
