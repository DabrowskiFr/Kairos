...
(** Parser diagnostics payload.
    ...
    This module stores source-level parse errors and non-fatal warnings
    produced during frontend parsing. *)

(** One parse error with optional source location. *)
type parse_error = { loc : Loc.loc option; message : string }

(** Parse information bundle attached to one parsed source. *)
type t = {
