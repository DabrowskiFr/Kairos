(** Contract-level helpers derived from product exploration, especially
    compatibility and assumption projections. *)
...
val add_assumption_projection_requires :
  ?log:(Abstract_model.transition -> Ast.ltl -> unit) option ->
