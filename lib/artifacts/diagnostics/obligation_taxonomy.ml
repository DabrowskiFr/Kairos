...
let family_name = function
  ...
  | FamGuaranteePropagationRequires -> "guarantee_propagation_requires"
  | FamGuaranteeAutomatonEnsures -> "guarantee_automaton_ensures"
...
let category_of_family = function
  ...
  | FamInitialInvariantGoal -> Some CatInitialGoal
  | FamInvariantRequires | FamInvariantEnsuresShifted -> Some CatUserInvariant
  | FamGuaranteePropagationRequires
  | FamGuaranteeAutomatonEnsures
