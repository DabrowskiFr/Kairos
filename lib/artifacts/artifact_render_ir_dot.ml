...
(* ------------------------------------------------------------------ *)
(* kernel node_ir (Proof_kernel_ir.node_ir)                          *)
(* ------------------------------------------------------------------ *)

let product_state_label (ps : Proof_kernel_ir.product_state_ir) : string =
  Printf.sprintf "%s_A%d_G%d" ps.prog_state ps.assume_state_index ps.guarantee_state_index

let dot_of_kernel_node_ir (n : Proof_kernel_ir.node_ir) : string =
  ...
  List.iter
    (fun (ps : Proof_kernel_ir.product_state_ir) ->
