...
let indexed_ident_many = Names.indexed_ident_many
...
let subst_ident = Subst.subst_ident
let nat_literal_of_ident = Subst.nat_literal_of_ident
let subst_ref = Subst.subst_ref
let subst_nat_expr = Subst.subst_nat_expr
let subst_expr = Subst.subst_expr
let subst_hexpr = Subst.subst_hexpr
let subst_spec_arg = Subst.subst_spec_arg
let subst_ltl = Subst.subst_ltl
let subst_stmt = Subst.subst_stmt
let subst_history_expr = Subst.subst_history_expr
