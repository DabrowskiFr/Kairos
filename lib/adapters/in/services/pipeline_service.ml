...
let instrumentation_pass = Pipeline_runtime.instrumentation_pass
let why_pass = Pipeline_runtime.why_pass
let obligations_pass = Pipeline_runtime.obligations_pass
...
let read_or_compile_kobj ~(input_file : string) =
  ...
  else Pipeline_runtime.compile_object ~input_file
...
let normalized_program = Pipeline_runtime.normalized_program
let ir_pretty_dump = Pipeline_runtime.ir_pretty_dump
let run = Pipeline_runtime.run
let run_with_callbacks = Pipeline_runtime.run_with_callbacks
