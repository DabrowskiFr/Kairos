...
module Usecases = Pipeline_usecases.Make (Pipeline_out_adapters.Ports)

let build_snapshot = Pipeline_out_adapters.Ports.Snapshot.build_snapshot
...
let compile_object = Pipeline_out_adapters.compile_object
