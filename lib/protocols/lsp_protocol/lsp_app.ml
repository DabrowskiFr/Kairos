...
let map_outputs (o : Pipeline_types.outputs) : Lsp_protocol.outputs =
  {
    ...
    guarantee_automaton_tex = o.guarantee_automaton_tex;
    assume_automaton_tex = o.assume_automaton_tex;
    product_tex = o.product_tex;
    product_tex_explicit = o.product_tex_explicit;
    canonical_tex = o.canonical_tex;
    ...
    product_dot_explicit = o.product_dot_explicit;
