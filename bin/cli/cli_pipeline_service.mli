...
type run_dump_data = {
  ...
  proof_traces : Kairos_engine_contract.Contract.proof_trace list;
}
...
type c_generation_data = Kairos_engine_contract.Contract.generated_file list

val proof_optimizations_of_args :
  Cli_types.cli_args -> Kairos_engine_contract.Contract.proof_optimizations
...
val why_text_dump :
  input_file:string ->
  proof_encoding:Kairos_engine_contract.Contract.proof_encoding ->
  proof_optimizations:Kairos_engine_contract.Contract.proof_optimizations ->
