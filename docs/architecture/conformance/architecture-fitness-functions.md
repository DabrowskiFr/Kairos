...
| Engine runtime split plan | `python3 scripts/check_architecture_fitness.py` | The proposed 17-library package boundary still matches Dune and has no unexpected inbound dependency |
