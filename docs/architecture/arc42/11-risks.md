...
| Proof export used for several audiences | Medium | Rocq exchange and diagnostics can evolve at different speeds | Version the exchange schema before Rocq synchronization |
| Spot/LTL translation outside the formal claim | Medium | Proof results are relative to the automata supplied to the reference kernel, not to Spot's translation correctness | Keep this parametric assumption explicit in the Rocq contract and architecture docs |
...
- minimal `--prove`;
- Rocq synchronization documentation.
...
1. Does it change product states, product steps, guards, or generated
   obligations?
2. Does Rocq need to know about it?
